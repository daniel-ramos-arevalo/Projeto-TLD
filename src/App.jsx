...
export default function App() {
 ...
 <section className="detalhes">
             <p className="text-center mt-4">
              <a href="inscreva.html" className="botões cor-botão">Inscreva-se agora</a>
            </p>
            <p className="text-center mt-4">
              <a href="jogos.html" target="_blank" className="botões cor-botão">Ir para a página de Jogos</a>
            </p>
          </section>
